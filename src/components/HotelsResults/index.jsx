...
export const HotelsResults = ({ hotels, descriptions: externalDescriptions }) => {
    ...
    const sortedHotels = useMemo(() => {
        const getPrice = (hotel) => hotel.composite_price_breakdown?.gross_amount?.value || hotel.price?.value || 0;
            ...
            <div className={styles.list}>
                {pageItems.map((hotel) => {
                    const description = externalDescriptions?.[hotel.hotel_id]
                        || hotelDescriptions[hotel.hotel_id]
                        || <LittleLoader />;
